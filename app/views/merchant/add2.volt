<div class="page-header">
    <h1>Добавить ломбард</h1>
</div>

<!-- <h4>Шаг 2</h4> -->
<!-- <p>Теперь необходимо заполнить данные ломбарда.</p> -->
<p>Необходимо заполнить данные ломбарда.</p>
<br><br>
    ...
    <div class="col-md-9">
        <form class="form-horizontal" id="add-merchant-1">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control"
                        id="inputName" placeholder="Пример: Лучший ломбард" name="name">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control"
                        id="inputAdress" placeholder="Пример: ул. Мира, строение 6, офис 5" name="adress">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control"
                        id="inputSite" placeholder="Пример: http://www.site.ru" name="site">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="list-group">
                        {% for aTag in allowedTags %}
                            <label class="list-group-item">
                                <input type="checkbox"
                                    class="tag-input"
                                    data-tag-id="{{aTag.id}}"> {{aTag.name}}
                            </label>
                        {% endfor %}
                    </div>
                </div>
            ...
            '/api/add-merchant-step-2', {
                ...
                success: function (result) {
                    ...
                    if (result && result.errors) {
                        ...
                        if (submit == 1) {
                            try {
                                yaCounter21293509.reachGoal('MerchantAddFinal');
                            } catch (e) {
                                console.error(e);
                            }
